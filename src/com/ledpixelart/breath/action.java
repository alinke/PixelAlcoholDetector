...
public class action extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		if (v.getId() == R.id.placesButton) {
			...
			.setClass(this,
					com.ledpixelart.breath.Places.class);
		...
		if (v.getId() == R.id.TaxiMagicButton) {
			Intent intent = new Intent()
			.setClass(this,
					com.ledpixelart.breath.getTaxi.class);
		...
		if (v.getId() == R.id.whereamiButton) {
			Intent intent = new Intent()
			.setClass(this,
					com.ledpixelart.breath.whereami.class);
		...
		if (v.getId() == R.id.facebookPostButton) {
			...
			if (!Utility.mFacebook.isSessionValid()) {				 
				...
				Intent intent = new Intent()
				.setClass(this,
						com.ledpixelart.breath.facebookPost.class);
		...
		if (v.getId() == R.id.tweetButton) {
			Intent intent = new Intent()
			.setClass(this,
					com.ledpixelart.breath.tweetPost.class);
